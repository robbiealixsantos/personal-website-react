            ...
            <div className="download-section">
                <div className="container">
                    <div className="col-lg-8 col-lg-offset-2">
                        ...
                        <a href="https://github.com/robbiealixsantos/coruscant-connect" className="btn btn-default btn-lg">Coruscant Connect - A social network for the planet Coruscant built on the MERN stack</a>
