...
class About extends Component {
    render() {
        ...
        <section id="about" className="container content-section text-center">
            <div className="row">
                <div className="col-md-4"><img alt="my face" src="https://media.licdn.com/dms/image/C4D03AQHOLLK3snbtiw/profile-displayphoto-shrink_200_200/0?e=1573084800&v=beta&t=lUOpspyL0UMC749-tHUp447aM01Jm6WZRgnZEXHOQs8"/></div>
